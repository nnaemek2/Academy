...
export const from = "Jean Byrd";
export const profession = 'Academy';
export const photoURL = 'https://academy.pnacorp.co.uk/logo192.png';
...
//STRIPE
export const stripePlanIdOne = "price_1RGFynEpJzzX5aStXeLrvv9O";
export const stripePlanIdTwo = "price_1RGG0YEpJzzX5aSt7saEH0JM";
